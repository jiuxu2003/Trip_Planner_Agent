...
class AmapService:
    ...
    def search_poi(self, keywords: str, city: str, citylimit: bool = True) -> List[POIInfo]: 
        ...
        Args:
            keywords (str): 搜索关键词
            city (str): 城市
            citylimit (bool, optional): 是否限制在城市范围内
        ...
        try:
            ...
            # 这里简化处理,实际应该解析JSON
            print(f"POI搜索结果: {result[:200]}...") # 打印前200字符串
    ...
    def plan_route(
        ...
        Args:
            ...
            origin_city (Optional[str], optional): 起点城市
            destination_city (Optional[str], optional): 终点城市
            route_type (str, optional): 路线类型(walking/driving/transit)
        ...
        try:
            ...
            if route_type =="transit":
                if origin_city:
                    arguments["origin_address"] = origin_city
                if destination_city:
                    arguments["destination_address"] = destination_city
